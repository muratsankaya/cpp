...
int main() {
    ...
    //test constructor
    Polynomial p0({}); //Should be 0
    Polynomial p20(emptyIntV); //Should be 0
    Polynomial p1({ 17 });                 // 17
    Polynomial p2({ 1, 2 });               // x + 2
    Polynomial p3({ -1, 5 });              // -x + 5
    Polynomial p4({ 5, 4, 3, 2, 1 });      // 5x^4 + 4x^3 + 3x^2 + 2x + 1
    Polynomial negp4({ -5, -4, -3, -2, -1 });   // -5x^4 - 4x^3 - 3x^2 - 2x - 1
    Polynomial onlyOne({ 1 }); // 1
    Polynomial has_a_zero({ 4, 0, 1, 7 }); // 4x^3 + x + 7
    Polynomial zero_polynomial;
   /* Polynomial temp(p4);
    cout << "temp: " << temp << endl << zero_polynomial << endl;*/
    ...
    cout << "p3: " << p3 << endl;
    cout << "p4: " << p4 << endl;
    cout << "negp4: " << negp4 << endl;
    cout << "onlyOne: " << onlyOne << endl;
    cout << "has_a_zero: " << has_a_zero << endl;
    
    Polynomial temp;
    temp = p2 + p3;
    cout << "temp: " << temp << endl << p2 << endl << p3 << endl;
    ...
    cout << "Evaluating p3 at " << x << " yields: " << p3.evaluate(5) << endl;
    ...
    cout << "p8 + p11 = " << p8 + p11 << endl; //Should result in a zero polynomial
    cout << "p0 + p0 = " << p0 + p0 << endl; //Should result in a zero polynomial
}
